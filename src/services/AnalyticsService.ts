...
import { linearRegressionSlope, median, rollingAverage } from '@/utils/stats';
...
// Re-exported, not redefined: the admin dashboard runs these same functions over the same data,
// and a second copy would let the two views of a patient's trend drift apart.
export { linearRegressionSlope, median, rollingAverage } from '@/utils/stats';
